...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function handleResumeUpload() {
        ...
        try {
            const response = await fetch("https://prepmateai-project-production-ab92.up.railway.app/upload-practice-resume", {
                method: "POST",
                body: formData,
            });
    ...
    async function generateAndShowFinalReport(reason) {
        ...
        try {
            const response = await fetch("https://prepmateai-project-production-ab92.up.railway.app/generate-final-report", {
                method: "POST",
    ...
    async function submitCommunicationAnswer() {
        ...
        try {
            const response = await fetch("https://prepmateai-project-production-ab92.up.railway.app/communication-feedback", {
                method: "POST",
                body: formData, 
            });
            const data = await response.json();
    ...
    async function sendInterviewAnswer(audioBlob, expressionsJSON) {
        ...
        try {
            const response = await fetch(`https://prepmateai-project-production-ab92.up.railway.app${endpoint}`, {
                method: "POST",
                body: formData, 
            });
